...
const translations = {
  en: {
    ...
    audios: {
      confirmDelete: "Are you sure you want to delete all narrations?",
      messages: {
        deleteSimulation: "Narrations deleted (simulation)!",
        deleteSuccess: "Narrations deleted!",
        deleteError: "Failed to delete narrations.",
        modeError: "Unable to verify the current mode.",
        downloadSimulation: "Simulated download started!",
        downloadStarted: "Download started!",
        downloadError: "Failed to download narrations.",
      ...
      actions: {
        ...
        cancel: "Cancel",
        deleteAll: "Delete All Narrations",
        downloadAll: "Download All Narrations",
      },
    },
    roadmap: {
  ...
  "pt-BR": {
    ...
    audios: {
      confirmDelete: "Tem certeza que deseja excluir todas as narrações?",
      messages: {
        deleteSimulation: "Narrações deletadas (simulação)!",
        deleteSuccess: "Narrações deletadas!",
        deleteError: "Falha ao deletar narrações",
        modeError: "Erro ao verificar modo de operação",
        downloadSimulation: "Download simulado iniciado!",
        downloadStarted: "Download iniciado!",
        downloadError: "Falha ao baixar narrações",
      ...
      actions: {
        ...
        cancel: "Cancelar",
        deleteAll: "Deletar Todas as Narrações",
        downloadAll: "Baixar Todas as Narrações",
      },
    },
    roadmap: {
